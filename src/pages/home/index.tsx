...
function HomeIndexPageCore(props: ViewComponentProps) {
  ...
  const WEIXIN_ICONS_SIZE_LIST: IconSizePayload[] = [
    { name: "icon_28x28", suffix: "png", width: 28, height: 28 },
    { name: "icon_108x108", suffix: "png", width: 108, height: 108 },
  ];
  const HUAWEI_ICONS_SIZE_LIST: IconSizePayload[] = [
    { name: "icon_216x216", suffix: "png", width: 216, height: 216 },
  ];
  const XIAOMI_ICONS_SIZE_LIST: IconSizePayload[] = [
    { name: "icon_512x512", suffix: "png", width: 512, height: 512 },
  ];
  const sizeGroups: Record<string, IconSizePayload[]> = {
    general: GENERAL_ICONS_SIZE_LIST,
    weixin: WEIXIN_ICONS_SIZE_LIST,
    huawei: HUAWEI_ICONS_SIZE_LIST,
    xiaomi: XIAOMI_ICONS_SIZE_LIST,
...
export const HomeIndexPage: ViewComponent = (props) => {
  ...
  return (
    <div class="bg-[#f8f9fa] min-h-screen">
        ...
        <div class="flex items-center justify-between w-[1080px] mx-auto">
          <div class="flex items-center">
            ...
            <div class="ml-2 text-gray-800 cursor-default">
              <div class="text-gray-600 text-3xl font-bold italic">ITRITON APPICONS</div>
            </div>
          </div>
          <div>
      ...
      <div class="w-[1080px] pb-[200px] mx-auto mt-8">
        <div
